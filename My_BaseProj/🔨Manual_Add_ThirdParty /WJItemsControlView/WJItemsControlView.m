...
-(instancetype)init{
    ...
    if(self = [super init]){
        ...
        _textColor = [UIColor colorWithRed:142/255.0
                                     green:142/255.0
                                      blue:142/255.0
                                     alpha:1];
        
        _selectedColor = [UIColor colorWithRed:61/255.0
                                         green:209/255.0
                                          blue:165/255.0
                                         alpha:1];
        
        _backGroundColor_normal = HEXCOLOR(0xF5F5F5);
        
        _backGroundColor_selected = HEXCOLOR(0xFF5050);
        
        _linePercent = 0.8;
        
        _lineHieght = 2.5;
        
        _type = XZBtnType_Standard;//默认值
    }
...
- (void)clickBtnWithIndex:(NSInteger)index{
    ...
    [self itemButtonClicked:(BadgeButton *)[self viewWithTag:index + 100]];
}
...
-(void)setTitleArray:(NSArray *)titleArray{
    ...
    for (int i = 0; i < titleArray.count; i++) {
        ...
        if (self.config.type == XZBtnType_Standard){
            ...
            if (btn.tag == 200) {
                ...
                btn.backgroundColor = self.config.backGroundColor_selected;
                
            } else {
                
                btn.backgroundColor = self.config.backGroundColor_normal;
            }
        }
        ...
        [btn setTitleColor:_config.textColor
                  forState:UIControlStateNormal];
      ...
      forControlEvents:UIControlEventTouchUpInside];
        ...
        if(i == 0){
           ...
           [btn setTitleColor:_config.selectedColor
                     forState:UIControlStateNormal];
...
#pragma mark ======== 点击事件 ======
-(void)itemButtonClicked:(BadgeButton*)btn{
...
-(void)changeItemColor:(NSInteger)index{
    ...
    for (int i = 0; i < _titleArray.count; i++) {
        ...
        BadgeButton *btn = (BadgeButton *)[self viewWithTag:i + 100];
        ...
        if (self.config.type == XZBtnType_Standard) {
            ...
            btn.backgroundColor = _config.backGroundColor_normal;
        }
        ...
        if(btn.tag == index + 100){
            ...
            if (self.config.type == XZBtnType_Standard) {
                ...
                btn.backgroundColor = _config.backGroundColor_selected;
            }
        }
    }
}
...
-(void)changeScrollOfSet:(NSInteger)index{
    ...
    [self setContentOffset:CGPointMake(leftSpace, 0)
                  animated:YES];
}
